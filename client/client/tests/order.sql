...
SELECT stu_name from oop_info ORDER BY stu_name;
SELECT COUNT(stu_name) from oop_info ORDER BY stu_name;
SELECT COUNT(stu_id) from oop_info ORDER BY stu_name; 
SELECT stu_name, COUNT(*) from oop_info ORDER BY stu_name;
DROP DATABASE OOP;
