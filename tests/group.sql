...
INSERT INTO oop_info(stu_id) VALUES (2016030040);
INSERT INTO oop_info(stu_id) VALUES (2016030023);
SELECT stu_name from oop_info GROUP BY stu_name;
SELECT COUNT(*) from oop_info GROUP BY stu_name;
